...
<body>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 lg:py-16 px-4 mx-auto max-w-8xl lg:px-4">
            ...
            <button type="button" class="flex mx-auto py-4 text-primary-600 dark-text-primary-400 hover:text-primary-700"
                data-collapse-toggle="detailed-pricing">Show Detailed Plan Comparison
            ...
            <div class="overflow-x-auto hidden" id="detailed-pricing">
