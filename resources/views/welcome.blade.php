...
<head>
    ...
    <title>{{ config('app.name', 'flowbite-JS') }}</title>
...
<body>
    ...
    <section class="pb-16 bg-white dark:bg-gray-900 lg:pb-24" id="pricing">
        <div class="px-4 mx-auto max-w-8xl lg:px-4">
            <h2
                class="mb-4 text-3xl font-bold text-gray-900 lg:font-extrabold lg:text-4xl lg:leading-snug dark:text-white lg:text-center 2xl:px-48">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-x-16 bg-gray-50 dark:bg-gray-800 p-8 rounded-t-lg">
                ...
                <div class="mb-8 md:mb-0">
                    ...
                    <p class="mb-4 text-sm text-gray-500 dark:text-gray-400">
                        Get started with an open source library of web components and interactive elements based on
                        Tailwind CSS.
                    </p>
                    <a href="#"
                ...
                <div class="mb-8 md:mb-0">
                    ...
                    <span class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">$269</span>
                    <p class="my-4 text-sm text-gray-500 dark:text-gray-400">
                        Recommended for professional developers and companies building enterprise-level websites and
                        applications.
                    </p>
                    <button
